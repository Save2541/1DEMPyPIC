...
plots = (2, 2)  # set space for plots (# of rows, # of columns)
plots_key = (("ex", "den0"), ("rho", "den1"))  # values to be plotted
...
plot_range_x = "full"# (0, 6)  # x-axis plot range (input: "full" for full plot)
plot_range_y = "full"# (0, 6)  # y-axis plot range (input: "full" for full plot)
...
specie_of_interest = 1  # index of the specie to focus on in the phase space animation (set to None to not focus)
