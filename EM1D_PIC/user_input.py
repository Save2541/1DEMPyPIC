...
nt = 16384 #131072  # number of time steps to run (please use powers of 2 e.g. 4, 8, 1024)
...
theta = 90 #math.degrees(1.38)  # magnetic field angle (deg) (e.g., 0 is along +z-axis, 90 is along +x-axis)
